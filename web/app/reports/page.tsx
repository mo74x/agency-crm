          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setMetrics({ ...metrics, visits: parseInt(e.target.value) })
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                value={metrics.leads}
                onChange={(e) =>
                  setMetrics({ ...metrics, leads: parseInt(e.target.value) })
                }
              />
            </div>
            ...
            >
              <div>
                ...
                <div className="flex gap-4 mt-2 text-sm text-gray-600">
                  <span>
                    Visits: <b>{report.content.visits}</b>
                  </span>
                  <span>
                    Leads: <b>{report.content.leads}</b>
                  </span>
                </div>
              </div>

              <PDFDownloadLink
                document={<ReportDocument data={report} />}
